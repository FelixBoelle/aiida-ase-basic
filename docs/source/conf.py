# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-ase-basic
#
...
release = aiida_ase_basic.__version__
...
html_use_opensearch = 'http://aiida-ase-basic.readthedocs.io'
...
htmlhelp_basename = 'aiida-ase-basic-doc'
