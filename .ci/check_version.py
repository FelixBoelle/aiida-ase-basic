...
Check version number in setup.json and aiida_ase_basic/__init__.py and make sure
they match.
"""
...
import aiida_ase_basic  # pylint: disable=wrong-import-position
version = aiida_ase_basic.__version__
